...
define('DB_HOST', 'mysql'); // Hardcoded for testing
define('DB_PORT', '3306'); // Hardcoded for testing
define('DB_USERNAME', 'travian_user'); // Hardcoded for testing
define('DB_PASSWORD', 'travian_password123'); // Hardcoded for testing
define('DB_DATABASE', 'travian_global'); // Hardcoded for testing
...
$globalConfig['dataSources']['globalDB']['hostname'] = 'mysql'; // Hardcoded for testing
$globalConfig['dataSources']['globalDB']['username'] = 'travian_user'; // Hardcoded for testing
$globalConfig['dataSources']['globalDB']['password'] = 'travian_password123'; // Hardcoded for testing
$globalConfig['dataSources']['globalDB']['database'] = 'travian_global'; // Hardcoded for testing
$globalConfig['dataSources']['globalDB']['charset'] = 'utf8mb4';
$globalConfig['dataSources']['globalDB']['port'] = 3306;
...
// Configuration validation removed - using hardcoded values for testing
